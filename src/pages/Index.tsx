...
import { Button } from "@/componentsimage/ui/button";
  ...
  return (
    <div className="min-h-screen bg-brand-50 text-brand-900 flex flex-col">
      ...
      <main className="flex-grow max-w-5xl mx-auto px-4 py-8 space-y-8">
        <section className="bg-white rounded-large shadow-medium p-8 border border-brand-100">
        ...
        <section className="bg-medical-50 rounded-large p-6 border border-medical-100">
